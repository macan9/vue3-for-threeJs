<template>
    <el-dialog v-model="visible.attr" title="用户编辑" width="80%" :before-close="handleClose" :modal="false"
        ...
        <el-input type="password" v-model="userForm.check_password" style="width: 200px" />
            ...
            <el-form-item label="用户权限" prop="role">
                <el-select v-model="userForm.auth" placeholder="请选择用户类型" disabled>
                    <el-option v-for="item in user_authority" :label="item.label" :value="item.value"
                        :key="item.value" />
                </el-select>
            </el-form-item>
        </el-form>
